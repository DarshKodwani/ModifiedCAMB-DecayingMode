    ...
    !Darsh: changing qmin0 from 0.1_dl to some value
...
101         if (CP%WantTransfer.and.itf <= CP%Transfer%num_redshifts) then
    ...
    !Darsh 2017: Change IntSampleBoost
    !Default: IntSampleBoost=AccuracyBoost
    IntSampleBoost=AccuracyBoost*2.d0
    !End Darsh
    ...
    if (CP%closed.and.ExactClosedSum) then
        ...
        !Darsh 2017
        !Default: lognum=nint(10*IntSampleBoost)
        lognum=nint(10*IntSampleBoost*10.)
        !End Darsh
        ...
        !Darsh 2017
        !Default: dk2 = 0.04/IntSampleBoost  !very small scales
        dk2 = dk0*10.
        !End Darsh
